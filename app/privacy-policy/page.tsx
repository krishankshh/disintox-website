        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <div className="prose prose-Hospital max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-Hospital-gray-900 mb-4">Introduction</h2>
              <p className="text-Hospital-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-Hospital-gray-900 mb-4">Information We Collect</h2>
              <p className="text-Hospital-gray-700 mb-4">
                When you request a product demonstration or contact us, we may collect:
              </p>
              <ul className="list-disc pl-6 text-Hospital-gray-700 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-Hospital-gray-900 mb-4">How We Use Your Information</h2>
              <p className="text-Hospital-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-Hospital-gray-900 mb-4">Data Security</h2>
              <p className="text-Hospital-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-Hospital-gray-900 mb-4">Your Rights</h2>
              <p className="text-Hospital-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-Hospital-gray-900 mb-4">Contact Us</h2>
              <p className="text-Hospital-gray-700 mb-4">
                If you have questions about this Privacy Policy or our data practices, please contact us:
              </p>
              <div className="bg-Hospital-gray-50 rounded-lg p-6">
                <p className="text-Hospital-gray-700"><strong>Email:</strong> {COMPANY_INFO.email}</p>
                <p className="text-Hospital-gray-700"><strong>Phone:</strong> {COMPANY_INFO.phone}</p>
                <p className="text-Hospital-gray-700 mt-2"><strong>Address:</strong> {COMPANY_INFO.address}</p>
              </div>
            </section>
