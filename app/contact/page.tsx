          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <div className="space-y-6">
              <div className="bg-chlorine-50 border border-chlorine-200 rounded-lg p-6">
                <h3 className="text-xl font-bold text-Hospital-gray-900 mb-4">Get in Touch</h3>
              ...
              <div className="bg-Hospital-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-Hospital-gray-900 mb-4">Office Address</h3>
                <p className="text-Hospital-gray-700">
                  {COMPANY_INFO.name}
                </p>
                <p className="text-Hospital-gray-600 mt-2">
                  {COMPANY_INFO.address}
                </p>
              </div>

              <div className="bg-chlorine-50 border border-chlorine-200 rounded-lg p-6">
                <h3 className="text-xl font-bold text-Hospital-gray-900 mb-4">Drug Licence Numbers</h3>
                <div className="space-y-2">
                  {COMPANY_INFO.drugLicenceNumbers.map((licence, index) => (
                    <p key={index} className="text-Hospital-gray-700 font-mono text-sm">
                      {licence}
                    </p>
                  ))}
                </div>
            ...
            <div className="bg-gradient-Hospital rounded-lg p-8 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-Hospital-gray-900 mb-4">
                Watch Product Demonstrations
              </h3>
              <p className="text-Hospital-gray-700 mb-6">
