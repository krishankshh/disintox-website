...
export const metadata = {
  title: 'Products - Disintox®',
  description: 'Explore our range of clinical-grade chlorine dioxide disinfection products for healthcare facilities.',
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl text-clinical-gray-600 mb-8 max-w-3xl mx-auto">
            Discover our comprehensive range of Disintox® chlorine dioxide disinfection solutions designed specifically for healthcare facilities.
          </p>
          <div className="bg-chlorine-50 border border-chlorine-200 rounded-lg p-8 mb-8">
            <p className="text-lg text-clinical-gray-700 mb-4">
              This page is currently under development. Our complete product catalog will be available soon.
            </p>
            <p className="text-clinical-gray-600">
              For immediate product information and inquiries, please contact our team directly.
            </p>
          </div>
