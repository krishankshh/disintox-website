...
export default function Home() {
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
            <div className="bg-white border border-clinical-gray-200 shadow-sm p-6 rounded-lg text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">99.99%</div>
              <p className="text-sm text-clinical-gray-600">Pathogen Elimination</p>
            </div>
            <div className="bg-white border border-clinical-gray-200 shadow-sm p-6 rounded-lg text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">30 Sec</div>
              <p className="text-sm text-clinical-gray-600">Contact Time</p>
            </div>
            <div className="bg-white border border-clinical-gray-200 shadow-sm p-6 rounded-lg text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">Safe</div>
              <p className="text-sm text-clinical-gray-600">Non-Toxic Formula</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Solutions by Sector - simplified */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SECTORS.map((sector, index) => (
              <div
                key={index}
                className="bg-white border border-clinical-gray-200 rounded-lg shadow-sm p-6"
              >
                <h3 className="text-xl font-bold text-clinical-gray-900 mb-3">
                  {sector.name}
                </h3>
                <div className="space-y-4">
                  <div>
                    <p className="text-sm font-semibold text-primary-600 mb-1">Challenge:</p>
                    <p className="text-sm text-clinical-gray-600">{sector.problem}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-secondary-600 mb-1">Solution:</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {PRODUCT_FEATURES.map((feature, index) => (
              <div
                key={index}
                className="bg-white border border-clinical-gray-200 p-4 rounded-lg shadow-sm flex items-center space-x-3"
              >
