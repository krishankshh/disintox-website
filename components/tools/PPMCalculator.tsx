    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl shadow-xl border-2 border-primary-200 p-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-clinical-gray-900 mb-2">
            PPM Calculator
          </h2>
          ...
          <button
            ...
            className={`px-8 py-3 rounded-lg font-semibold transition-all ${
              calculatorMode === 'tablets'
                ...
                : 'bg-clinical-gray-100 text-clinical-gray-700 hover:bg-clinical-gray-200'
            }`}
          >
            💊 Tablets
          </button>
        ...
        {calculatorMode === 'tablets' ? (
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-6 border border-primary-200">
              <h3 className="text-xl font-bold text-clinical-gray-900 mb-4">
                Calculate Tablets Needed
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., 100"
                    className="w-full px-4 py-3 border-2 border-clinical-gray-300 rounded-lg focus:border-primary-500 focus:outline-none"
                  />
                </div>
              ...
              {tabletResult && (
                <div className="bg-white rounded-lg p-6 border-2 border-primary-400">
                  ...
                  <div className="space-y-2">
                    <p className="text-clinical-gray-900">
                    ...
                    <p className="text-sm text-clinical-gray-700 mt-3 pt-3 border-t border-clinical-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setVolume(e.target.value)}
                    placeholder="e.g., 100"
                    className="w-full px-4 py-3 border-2 border-clinical-gray-300 rounded-lg focus:border-secondary-500 focus:outline-none"
                  />
                </div>
            ...
            {/* Reference Guide */}
            <div className="bg-clinical-gray-50 rounded-xl p-6 border border-clinical-gray-200">
              <h3 className="text-lg font-bold text-clinical-gray-900 mb-4">📚 Reference Guide</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-semibold text-clinical-gray-900 mb-2">Standard Ratio:</h4>
                  <p className="text-sm text-clinical-gray-700">1 tablet per 10L water = 100 PPM</p>
                </div>
                <div>
                  <h4 className="font-semibold text-clinical-gray-900 mb-2">Recommended PPM:</h4>
                  <ul className="text-sm text-clinical-gray-700 space-y-1">
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-2xl font-bold text-clinical-gray-900 mb-3">
              Disintox® Gel
            </h3>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-6 border border-primary-200 max-w-2xl mx-auto">
              <h4 className="font-bold text-clinical-gray-900 mb-3">Application Instructions:</h4>
              <ul className="text-left text-clinical-gray-700 space-y-2">
