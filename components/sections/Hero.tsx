        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 animate-fade-in-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-4 sm:pt-6">
              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border-2 border-primary-100 hover:shadow-2xl hover:-translate-y-1 transition-all">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-primary-600 mb-2 sm:mb-3">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border-2 border-secondary-100 hover:shadow-2xl hover:-translate-y-1 transition-all">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-secondary-600 mb-2 sm:mb-3">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border-2 border-accent-100 hover:shadow-2xl hover:-translate-y-1 transition-all">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-accent-600 mb-2 sm:mb-3">3-4h</div>
                <div className="text-sm sm:text-base font-bold text-clinical-gray-700 uppercase tracking-wide">Fumigation</div>
