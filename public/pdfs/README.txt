...
IMPORTANT: Replace these placeholder files with actual PDF certificates before production deployment.

For production:
- Ensure all PDFs are optimized and compressed
