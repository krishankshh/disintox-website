      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-lg shadow-sm border border-clinical-gray-200 p-6 text-center">
            ...
            <div className="text-sm text-clinical-gray-600">Facilities Served</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-clinical-gray-200 p-6 text-center">
            <div className="text-4xl font-bold text-primary-600 mb-2">99.99%</div>
            <div className="text-sm text-clinical-gray-600">Average Efficacy</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-clinical-gray-200 p-6 text-center">
            <div className="text-4xl font-bold text-primary-600 mb-2">70%</div>
            <div className="text-sm text-clinical-gray-600">Time Saved</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-clinical-gray-200 p-6 text-center">
            <div className="text-4xl font-bold text-primary-600 mb-2">5+</div>
            <div className="text-sm text-clinical-gray-600">Years Experience</div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          {caseStudies.map((study) => (
            <article
              key={study.id}
              className="bg-white rounded-lg shadow-sm border border-clinical-gray-200 p-8"
            >
              {/* Header */}
              <div className="mb-6">
                <div className="flex flex-wrap items-center gap-3 mb-3">
                  ...
                  <span className="text-clinical-gray-500 text-sm">📍 {study.location}</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-clinical-gray-900">
                  {study.title}
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-clinical-gray-700 leading-relaxed">{study.challenge}</p>
                  </div>

                  {/* Solution */}
                  <div>
                    <h3 className="text-lg font-bold text-secondary-600 mb-2">Solution</h3>
                    <p className="text-clinical-gray-700 leading-relaxed">{study.solution}</p>
                  </div>

                  {/* Testimonial */}
                  <div className="bg-clinical-gray-50 rounded-lg p-6 border-l-4 border-primary-600">
                    <p className="text-clinical-gray-700 italic mb-3">"{study.testimonial}"</p>
                    <p className="text-sm text-clinical-gray-600 font-semibold">
                      — {study.designation}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {/* Results */}
                  <div>
                    <h3 className="text-lg font-bold text-clinical-gray-900 mb-3">Results Achieved</h3>
                    <ul className="space-y-3">
                      {study.results.map((result, index) => (
                        <li key={index} className="flex items-start gap-3">
                          ...
                          <span className="text-clinical-gray-700">{result}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-lg p-6">
                    <h3 className="text-lg font-bold text-clinical-gray-900 mb-4">Key Metrics</h3>
                    <div className="grid grid-cols-2 gap-4">
                      {Object.entries(study.metrics).map(([key, value], index) => (
                        <div key={index}>
                          <div className="text-2xl font-bold text-primary-600 mb-1">{value}</div>
                          <div className="text-xs text-clinical-gray-600 capitalize">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm border border-clinical-gray-200 p-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-clinical-gray-900 mb-4">
