...
const caseStudies = [
  {
    ...
    solution: 'Implemented Disintox® Chlorine Dioxide (ClO<sub>2</sub>) tablets for daily fumigation of ICU, OT, and high-risk areas. Reduced fumigation time to 3-4 hours.',
    results: [
  ...
  },
  {
    ...
    solution: 'Switched to Disintox® Chlorine Dioxide (ClO<sub>2</sub>) for water disinfection. Implemented at 100 PPM concentration vs 1000+ PPM with traditional chlorine.',
    results: [
    ...
    testimonial: 'The switch to Chlorine Dioxide (ClO<sub>2</sub>) has improved water quality while reducing our chemical footprint significantly.',
