...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-b from-clinical-gray-50 to-white overflow-x-hidden">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-clinical-gray-900">
              Clinical-Grade
              <br />
            ...
            <p className="text-lg sm:text-xl text-clinical-gray-600 leading-relaxed max-w-xl">
              Eliminate <span className="font-bold text-primary-600">99.99%</span> of pathogens with
              <span className="text-clinical-gray-900 font-semibold"> chlorine dioxide tablets</span> —
              trusted by India's leading healthcare facilities
            </p>

            {/* Stats Row - simplified */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 max-w-4xl">
              <div className="bg-white rounded-lg p-6 shadow-md border border-clinical-gray-200">
                <div className="text-4xl font-bold text-primary-600 mb-2">
                  <CountUpNumber end={99.99} decimals={2} suffix="%" />
                </div>
                <div className="text-sm font-semibold text-clinical-gray-700">Efficacy Rate</div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md border border-clinical-gray-200">
                ...
                <div className="text-sm font-semibold text-clinical-gray-700">Non-Toxic</div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md border border-clinical-gray-200">
                ...
                <div className="text-sm font-semibold text-clinical-gray-700">Fumigation</div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-6 border-t border-clinical-gray-200">
              <span className="text-sm text-clinical-gray-500 font-medium w-full sm:w-auto">Approved by:</span>
              <div className="flex flex-wrap items-center gap-3">
                <div className="px-4 py-2 bg-white rounded-lg shadow-sm border border-clinical-gray-200">
          ...
          <div className="relative mt-12 lg:mt-0">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 max-w-md mx-auto">
              <div className="bg-white rounded-lg p-4 shadow-md border border-clinical-gray-200 text-center">
                <div className="text-sm font-semibold text-clinical-gray-600 mb-1">Patent #</div>
                <div className="text-2xl font-bold text-primary-600">386338</div>
                <div className="text-xs text-clinical-gray-500 mt-1">Indian Patent</div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-md border border-clinical-gray-200 text-center">
      ...
      <div className="hidden sm:flex absolute bottom-12 left-1/2 transform -translate-x-1/2">
        <div className="flex flex-col items-center gap-2">
          <span className="text-sm text-clinical-gray-500">Scroll to explore</span>
