...
export const metadata = {
  ...
  description: 'Real-world success stories of Disintox® implementation in healthcare facilities across India.',
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl text-clinical-gray-600 mb-8 max-w-3xl mx-auto">
            Discover how leading healthcare facilities have successfully implemented Disintox® to improve patient safety and reduce hospital-acquired infections.
          </p>
          <div className="bg-chlorine-50 border border-chlorine-200 rounded-lg p-8 mb-8">
            <p className="text-lg text-clinical-gray-700 mb-4">
              This page is currently under development. Detailed case studies from our hospital partners will be available soon.
            </p>
            <p className="text-clinical-gray-600">
              For references and client testimonials, please reach out to our team directly.
            </p>
          </div>
